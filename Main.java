...
public class Main {
    ...
    public static void main(String[] args)  {
        ...
        do {
            ...
            Pattern pattern_roman = Pattern.compile("^(I|II|III|IV|V|VI|VII|VIII|IX|X) ([*-/+]) (I|II|III|IV|V|VI|VII|VIII|IX|X)$");
            ...
            if (!(t)&!(t_roman)) {
                try {
                    ...
                    Pattern pattern_operationR = Pattern.compile("^(I|II|III|IV|V|VI|VII|VIII|IX|X) [^+*/-] (I|II|III|IV|V|VI|VII|VIII|IX|X)$");
                    ...
                    Pattern pattern_operationA = Pattern.compile("^([1-9]|10) ([^+*/-]) ([1-9]|(10))$");
                    ...
                    Pattern twoSystem = Pattern.compile("^([1-9]|10) ([*-/+]) (I|II|III|IV|V|VI|VII|VIII|IX|X)$");
                    ...
                    Pattern twoSystemSwap = Pattern.compile("^(I|II|III|IV|V|VI|VII|VIII|IX|X) ([*-/+]) ([1-9]|(10))$");
